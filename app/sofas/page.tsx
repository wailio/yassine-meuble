      ...
      <main className="min-h-screen pt-20 md:pt-24" style={{ backgroundColor: "#eff0f1" }}>
        <div className="max-w-7xl mx-auto px-3 md:px-6 py-8 md:py-12">
          ...
          <div className="mb-8 md:mb-16">
            <h1 className="text-2xl md:text-5xl lg:text-6xl font-serif font-bold text-gray-900 mb-2 md:mb-4">Canapés</h1>
            ...
            <p className="text-xs md:text-lg text-gray-700 max-w-3xl leading-relaxed hidden md:block">
              Découvrez notre collection de canapés modernes, du minimaliste au luxe sectionniel. Chaque pièce est fabriquée pour le confort et le style.
            </p>
          </div>
                ...
                <div className="group cursor-pointer bg-white overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <div className="p-3 md:p-8">
                    <div className="flex items-start justify-between mb-2 md:mb-4">
                      <div>
                        <h3 className="text-base md:text-2xl font-serif font-bold text-gray-900 mb-1 md:mb-2">{sofa.name}</h3>
                        <div className="h-0.5 w-8 md:w-12 bg-[#8b7344]"></div>
                      </div>
                    </div>
                    <p className="text-gray-700 text-xs md:text-base mb-3 md:mb-6 leading-relaxed hidden md:block">{sofa.description}</p>
                    <div className="flex items-center justify-between">
                      <p className="text-[#8b7344] font-bold text-base md:text-2xl">{sofa.price}</p>
