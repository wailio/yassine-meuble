...
const arabicTranslations: Record<string, string> = {
  ...
  "À Propos Yassine Meubles": "عن Yassine Meubles",
  ...
  "Pourquoi choisir Yassine Meubles": "لماذا تختارون Yassine Meubles",
  ...
  "Chez Yassine Meubles, nous croyons que votre maison doit refléter votre style personnel et vos valeurs. Notre mission est de fournir des meubles exceptionnels qui transforment les espaces en havres de confort et d'élégance.": "في Yassine Meubles، نؤمن بأن منزلكم يجب أن يعكس أسلوبكم الشخصي وقيمكم. مهمتنا هي تقديم أثاث استثنائي يحوّل المساحات إلى ملاذات من الراحة والأناقة.",
  "Fondée avec une vision de redéfinir le mobilier de luxe, Yassine Meubles a commencé comme un projet passionné pour apporter des pièces soigneusement sélectionnées et de haute qualité aux clients discernants.": "تأسست برؤية لإعادة تعريف الأثاث الفاخر، وبدأت Yassine Meubles كمشروع شغوف يهدف إلى تقديم قطع مختارة بعناية وعالية الجودة للعملاء ذوي الذوق الرفيع.",
  "Des meubles inspirants pour des intérieurs qui vous ressemblent.": "أثاث ملهم لمساحات داخلية تشبهكم.",
  "Excellente qualité de meubles ! J'ai acheté un canapé et une table basse chez Yassine Meubles. Les produits sont vraiment magnifiques et bien finis. L'équipe a été très attentive et m'a conseillée sur les meilleures options. Je recommande vivement !": "جودة أثاث ممتازة! اشتريت أريكة وطاولة قهوة من Yassine Meubles. المنتجات رائعة ومصنعة بإتقان. كان الفريق متعاونًا جدًا ونصحني بأفضل الخيارات. أوصي بها بشدة!",
  "Transformé mon salon complètement ! Les meubles de Yassine Meubles ont une qualité exceptionnelle. Le design est moderne et élégant, exactement ce que je cherchais. Livraison rapide et service client très professionnel.": "لقد غيّرت أثاث غرفة جلوسي بالكامل! أثاث Yassine Meubles بجودة استثنائية. التصميم عصري وأنيق، تمامًا كما كنت أبحث عنه. توصيل سريع وخدمة عملاء احترافية جدًا.",
